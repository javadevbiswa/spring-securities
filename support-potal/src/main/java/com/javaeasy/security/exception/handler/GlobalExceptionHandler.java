package com.javaeasy.security.exception.handler;
...
public class GlobalExceptionHandler implements ErrorController {
	...
	public ResponseEntity<HttpResponse> emailNotFoundException(TemplateInputException exception) {
		return createHttpResponse(INTERNAL_SERVER_ERROR, "This page is not found");
	}
...
//	}
	...
	/*
	 * @RequestMapping(value = "/error-path") public ResponseEntity<HttpResponse>
	 * pageNotFound() { return createHttpResponse(BAD_REQUEST, "page Not Found "); }
	 */
